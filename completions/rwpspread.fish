...
complete -c rwpspread -s d -l daemon -d 'Enable daemon mode and resplit on output changes'
complete -c rwpspread -s p -l palette -d 'Generate a color palette from input image'
complete -c rwpspread -s s -l swaylock -d 'Enable swaylock integration'
complete -c rwpspread -l hyprlock -d 'Enable hyprlock integration'
